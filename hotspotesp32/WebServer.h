...
#define HTTP_DOWNLOAD_UNIT_SIZE 256
#ifndef HTTP_UPLOAD_BUFLEN
#define HTTP_UPLOAD_BUFLEN 256
#endif
256
#define HTTP_MAX_DATA_WAIT 1000 //ms to wait for the client to send the request
#define HTTP_MAX_POST_WAIT 1000 //ms to wait for POST data to arrive
#define HTTP_MAX_SEND_WAIT 1000 //ms to wait for data chunk to be ACKed
#define HTTP_MAX_CLOSE_WAIT1500 //ms to wait for the client to close the connection

5#define CONTENT_LENGTH_UNKNOWN ((size_t) -1)
